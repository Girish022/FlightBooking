...
import { SelectBusComponent } from './user/select-flight/select-flight.component';
import { SelectSeatComponent } from './user/select-seat/select-seat.component';
import { BusSearchResultComponent } from './user/flight-search-result/flight-search-result.component';
